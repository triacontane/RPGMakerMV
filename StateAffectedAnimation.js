...
/*:
 * @plugindesc StateAffectedAnimationPlugin
 * @author triacontane
 *
 * @help StateAffectedAnimation.js
 *
 * This plugin is released under the MIT License.
 */
/*:ja
 * @plugindesc ステート付与時プラグイン
 * @author トリアコンタン
 *
 * @param commandPrefix
 * @text メモ欄接頭辞
...
(function() {
    ...
    var param = createPluginParameter('StateAffectedAnimation');
