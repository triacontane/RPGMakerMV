...
----------------------------------------------------------------------------
 Version
 1.0.1 2018/08/30 gotoTitleOrTestが毎フレーム繰り返し呼ばれていたのを修正
=============================================================================*/
    ...
    Scene_Splash.prototype.update = function() {
        if (Liquidize.MadeWithMV.ShowMV) {
            if (!this._mvFadeIn) {
                ...
                this._mvFadeIn = true;
            } else if (this._mvWaitTime > 0 && this._mvFadeOut == false) {
                    this._mvWaitTime--;
                } else if (this._mvFadeOut == false) {
        ...
        if (Liquidize.MadeWithMV.ShowCustom) {
            if (Liquidize.MadeWithMV.ShowMV && this._mvFadeOut == true) {
                ...
                } else if (this._customWaitTime > 0 && this._customFadeOut == false) {
                        this._customWaitTime--;
                    } else if (this._customFadeOut == false) {
