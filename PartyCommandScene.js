...
(function() {
    ...
    var param = createPluginParameter('PartyCommandScene');
    if (!param.SceneList) {
        param.SceneList = [];
    }
    ...
    SceneManager.pushPartyCommandScene = function(sceneData) {
        ...
        var scene = window[sceneData.SceneType];
        if (!scene) {
    ...
    SceneManager.findShopGoods = function(sceneData) {
        ...
        if (sceneData.ShopItems) {
            goods = goods.concat(sceneData.ShopItems.map(function(id) {
                return [0, id, 0, 0];
            }));
        }
        if (sceneData.ShopWeapons) {
            goods = goods.concat(sceneData.ShopWeapons.map(function(id) {
                return [1, id, 0, 0];
            }));
        }
        if (sceneData.ShopArmors) {
            goods = goods.concat(sceneData.ShopArmors.map(function(id) {
                return [2, id, 0, 0];
            }));
        }
        return goods;
    ...
    Window_PartyCommand.prototype.makeCommandList = function() {
        ...
        param.SceneList.forEach(function(scene) {
    ...
    Scene_Battle.prototype.createPartyCommandWindow = function() {
        ...
        this._partyCommandWindow.setHandler('partyCommandScene', function () {
            var sceneData = this._partyCommandWindow.currentExt();
    ...
    Scene_Battle.prototype.startPartyCommandSelection = function() {
        ...
        if (Scene_Battle._partyCommandIndex >= 0) {
            this._partyCommandWindow.select(Scene_Battle._partyCommandIndex);
    ...
    var _Sprite_Actor_moveToStartPosition = Sprite_Actor.prototype.moveToStartPosition;
