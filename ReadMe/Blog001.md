　ツクールMVのゲームはエンジンであるNW.jsを最新バージョンに差し替えることで様々な恩恵を受けることができます。（2017/12/25時点で非公式なので自己責任で行う必要があります）
...
## 動作が高速化する  
　これが最大の利点です。主に改善するのは画面を移動したり、画像を表示したりするときの硬直時間です。逆に現時点で特にパフォーマンスに問題を感じていないのであれば特に更新する必要はありません。
