...
(function() {
    ...
    Game_Player.prototype.moveByInput = function() {
        if (!$fple) {
            ...
            var rightKey = $fple.isBabylon3() ? 'left' : 'right';
            var leftKey  = $fple.isBabylon3() ? 'right' : 'left';
            if (Input.isPressed(rightKey)) {
...
(function() {
    ...
    MBS.FPLE.Scene.prototype.isBabylon3 = function() {
        var version = BABYLON.Engine.Version;
